...
Então vejo uma mensagem "Saldo insuficiente para o saque :("
E meu saldo final deve ser R$ 0

Cenário: Tenho saldo mas não o suficiente
Dado que eu tenho R$ 500 em minha conta
...
Então vejo uma mensagem "Limite maximo por saque é de R$ 700"
